...
exports.migrations1670501439239 = void 0;
class migrations1670501439239 {
    constructor() {
        this.name = 'migrations1670501439239';
    }
    up(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield queryRunner.query(`CREATE TABLE \`reviews\` (\`id\` varchar(36) NOT NULL, \`description\` varchar(255) NULL, \`rating\` decimal NOT NULL, \`title\` varchar(255) NULL, \`experienceDate\` date NULL, \`createdAt\` timestamp NULL DEFAULT '2022-12-08 12:10:42', \`userId\` varchar(36) NULL, \`companyId\` varchar(36) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
...
exports.migrations1670501439239 = migrations1670501439239;
//# sourceMappingURL=1670501439239-migrations.js.map