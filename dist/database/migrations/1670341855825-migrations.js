...
exports.migrations1670341855825 = void 0;
class migrations1670341855825 {
    constructor() {
        this.name = 'migrations1670341855825';
    }
    up(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield queryRunner.query(`CREATE TABLE \`reviews\` (\`id\` varchar(36) NOT NULL, \`description\` varchar(255) NULL, \`rating\` decimal NOT NULL, \`title\` varchar(255) NULL, \`experienceDate\` date NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`userId\` varchar(36) NULL, \`companyId\` varchar(36) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
            yield queryRunner.query(`CREATE TABLE \`companies\` (\`id\` varchar(36) NOT NULL, \`email\` varchar(255) NOT NULL, \`name\` varchar(255) NOT NULL, \`avatar\` varchar(255) NULL, \`description\` varchar(255) NULL, \`reviewsQuantity\` float NOT NULL, \`address\` varchar(255) NULL, \`phone\` varchar(255) NULL, \`banned\` tinyint NOT NULL DEFAULT 0, \`country\` varchar(255) NULL, \`city\` varchar(255) NULL, \`website\` varchar(255) NOT NULL, \`workEmail\` varchar(255) NOT NULL, \`ratingGeneral\` float NOT NULL, \`password\` varchar(255) NOT NULL, \`roleId\` int NOT NULL, UNIQUE INDEX \`IDX_3e7b86aa8b4ffe84947ff29c0b\` (\`website\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
...
exports.migrations1670341855825 = migrations1670341855825;
//# sourceMappingURL=1670341855825-migrations.js.map