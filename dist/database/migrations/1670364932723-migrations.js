...
exports.migrations1670364932723 = void 0;
class migrations1670364932723 {
    constructor() {
        this.name = 'migrations1670364932723';
    }
    up(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield queryRunner.query(`CREATE TABLE \`reviews\` (\`id\` varchar(36) NOT NULL, \`description\` varchar(255) NULL, \`rating\` decimal NOT NULL, \`title\` varchar(255) NULL, \`experienceDate\` date NULL, \`createdAt\` timestamp NOT NULL, \`userId\` varchar(36) NULL, \`companyId\` varchar(36) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
...
exports.migrations1670364932723 = migrations1670364932723;
//# sourceMappingURL=1670364932723-migrations.js.map